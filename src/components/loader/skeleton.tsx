...
const LoaderSkeleton: React.FC = () => {
  return (
    <div
      role="status"
      className="mx-8 space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center"
    >
      ...
      <span className="flex items-center justify-center text-center sr-only ">
        Loading...
      </span>
    </div>
  );
